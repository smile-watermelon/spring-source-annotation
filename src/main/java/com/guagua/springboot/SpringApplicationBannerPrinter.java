...
class SpringApplicationBannerPrinter {
    ...
    Banner print(Environment environment, Class<?> sourceClass, Log logger) {
        ...
        return new org.springframework.boot.SpringApplicationBannerPrinter.PrintedBanner(banner, sourceClass);
    }
    ...
    private Banner getBanner(Environment environment) {
        org.springframework.boot.SpringApplicationBannerPrinter.Banners banners = new org.springframework.boot.SpringApplicationBannerPrinter.Banners();
